...
import com.akira.reggie.dto.DishDto;
...
import com.akira.reggie.mapper.DishMapper;
...
public class DishServiceImpl extends ServiceImpl<DishMapper,Dish> implements DishService {
    ...
    public void saveWithFlavor(DishDto dishDto) {
        //保存菜品的基本信息到菜品表dish
//        System.out.println("1111111111"+dishDto.getId()); //save前id为null
        this.save(dishDto);
//        System.out.println("2222222222"+dishDto.getId());//save后id通过雪花算法生成写入到对象中了
